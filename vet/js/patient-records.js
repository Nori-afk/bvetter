			...
			<div class="detail-two-column">
				<article class="info-card detail-info-card">
					<div class="detail-header">
						<img src="/final-VBETTER/bvetter/vet/images/info.svg" alt="Physical information">
...
function renderAdd(record) {
	...
	return `
		<section class="records-shell">
			<div class="section-head">
				<div>
					<button type="button" class="btn btn-soft" data-nav="list"><img src="/final-VBETTER/bvetter/vet/images/back.svg" alt="Back">Back to records</button>
					<h2>${pageTitle}</h2>
			...
			<form id="record-form" class="form-layout">
				<article class="form-card">
					...
					<img src="/final-VBETTER/bvetter/vet/images/paw-green.svg" alt="Pet-icon">
				...
				<article class="form-card">
				<div class="detailed-header">
					<img src="/final-VBETTER/bvetter/vet/images/owner.svg" alt="Owner-icon">
				...
				<div class="detailed-header">
					<img src="/final-VBETTER/bvetter/vet/images/medicine.svg" alt="Visit-icon">
					<h3>Visit Details</h3>
					</div>
					<div class="form-grid">
						<div class="field span-2">
